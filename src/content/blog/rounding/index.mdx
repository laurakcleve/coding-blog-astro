...
One solution to this problem is to use the <a href="https://en.wikipedia.org//wiki/Largest_remainder_method" target="_blank" rel="noopener noreferrer">Largest Remainder method</a>.
